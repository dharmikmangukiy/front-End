    ...
    <>
      ...
      <div className="heroBanner" style={{ height: "750px" }}>
        <div className="backdrop-img">
          <Img src="https://occ-0-6246-2186.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABT-gRT0J2kaA0UPX_7tgo_rnEuGl-LlDIM_HLHNuoUWRtuZ8njF-HD0dNNXJfjPO5Zh2m_HDdxkjl0tbS3Wvt2OvLSB2G0lGFcY4.webp?r=89e" />
        </div>
        <div className="mx-5 ">
          <Img
            src="https://occ-0-6246-2186.1.nflxso.net/dnm/api/v6/LmEnxtiAuzezXBjYXPuDgfZ4zZQ/AAAABct73m5eMUR8GLE0KkBubJ-qChflATmWKQKNGTURH2sLclqlW2Vhdy6rA1G-D3vwRfOoBDWD6bShVQN4cQAS5m_m1Z0_Ms3nVNZ-A9ZcMGDkEp9601RZStRardjy3dkssOiO1ec7xitJJwPARAqwGQr9cd7_jCla8qyJV1yRYC2C3FrYadv12w.webp?r=c41"
            alt="name"
          />
        </div>
        <div className="opacity-layer">
          ...
          <div className="pt-3 px-5 d-flex justify-content-between ">
            <h5 className="text-white">
              This docuseries follows the rise and fall of Veerappan, a dreaded{" "}
              <br />
